...
`tests/corpus-evaluation.rs` are the gate, and there are six: precision at 90%
or better, two native zh-TW false-positive rates each at 5% or less, and three
safe-fix rates, 85% on the AI-generated corpus and 99% on the zh-CN conversion
and native ones. A rule that is a false friend,
